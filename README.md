...
Let $r(t)$ be the reference of angular position, $y(t)$ the angular position, $u(t)$ the control signal, and $e(t)$ the tracking error. First, a relay experiment should be performed in order to obtain the critical gain $K_{u}$ and critical period $P_u$:
<p align="center">
...
Assuming a problem of sinusoidal reference tracking with a 90 degrees amplitude and frequency of 0.1 Hz, for a PID controller the following response is obtained:
<p align="center">
